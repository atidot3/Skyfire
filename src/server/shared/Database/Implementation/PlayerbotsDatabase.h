...
public:
    ...
    PlayerbotsDatabaseConnection(ACE_Activation_Queue* q, MySQLConnectionInfo& connInfo);
...
typedef DatabaseWorkerPool<PlayerbotsDatabaseConnection> PlayerbotDatabaseWorkerPool;
